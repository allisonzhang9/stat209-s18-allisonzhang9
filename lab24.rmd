...
Write you exploratory analysis here: In more affluent neighborhoods, narcotic crimes are more likely to result in arrest than in lower income neighborhoods. 

```{r}
crimes_narcotics_ca <- group_summarize(crimes, area_number, narcotics)
crimes_narcotics_ca <- left_join(crimes_narcotics_ca, ca, by = "area_number")
crimes_narcotics_ca <-filter(crimes_narcotics_ca, narcotics==1 )



ggplot(crimes_narcotics_ca, aes(median_income, arrest_flag_mean))+
