...
ggplot(mpg, aes(displ,hwy)) +
  ...
  geom_point(aes(y=cty), color="red")+
  ylab("Miles Per Gallon")+
  xlab("Size of the Engine in Liters")+
  ggtitle("Size of Engine vs Miles Per Gallon")
```
...
Yes, the South is much more prop_hillary than all other regions of the United States
