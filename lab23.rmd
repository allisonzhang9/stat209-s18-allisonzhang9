...
**Answer**: This means that 17 percent of crimes lead to arrest.
...
**Answer**: This means that 27 percent of crimes were classified as a theft.
...
**Answer**: It is the number of crimes classified as theft for all of the crimes
...
**Answer**: 36 thefts per 1000 households
...
**Answer**: This is larger than the mean over the entire dataset. We can compare these because they are both averages.
...
**Answer**: This is smaller than the mean of the theft flag over the entire dataset. We can compare these because they are both averages.
...
**Answer**: This is smaller than the entire dataset. We can't compare these because they are the sums not the averages.
...
```{r}
humboldt <-filter(ca, area_number==23)
humboldt$num_households
```
...
**Answer**: As medium income increases, theft_rate decreases. There is one big outlier
...
**Answer**: It is the central business district, and there are a large number of tourists. 
