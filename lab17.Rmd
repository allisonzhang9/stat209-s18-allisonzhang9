...
**Answer**:31.0, the third bucket's cutoff number is 31.0
...
**Answer**: 30,00, it is the cutoff for the 16th bin 
...
**Answer**: they have the least number or reviews
...
**Answer**: Matcha has a larger price than most of the other types, and also has the lowest score of all the tea types.
