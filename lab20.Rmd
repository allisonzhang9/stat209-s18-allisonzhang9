...
**Answer**:It has a positive slope
...
**Answer**: Yes, because it is outside of the confidence interval

Would you be surprised if we collected another set of diamonds, in exactly the
same way as before, and found a slope estimate equal to 7500?

**Answer**: Yes, because it is outside of the confidence interval as well
...
**Answer**: This is important because we need to know if the slope is positive or negative, and in this linear regression it is all positive so we know for a fact that the slope is positive and there is a positive correlation between carat and price.
...
**Answer**: The estimate of the slope is between -53.15 and -6.15
...
**Answer**: we know that the slope is negative, so as depth increases, price decreases.
...
**Answer**: yes, because for depth they are both negative, and for carat they are both positive
...
**Answer**: As depth increases, price decreases. As carat increases, price increases.
...
**Answer**: I expect the heavier diamond to cost 7765 more.
